...
class CnnActorCriticNetwork2(nn.Module):
    def __init__(self, input_size, output_size, use_noisy_net=False):
        super(CnnActorCriticNetwork2, self).__init__()
...
class RNDModel2(nn.Module):
    def __init__(self, input_size, output_size):
        super(RNDModel2, self).__init__()

        self.input_size = input_size
        self.output_size = output_size

        feature_output = 10 * 10 * 64
